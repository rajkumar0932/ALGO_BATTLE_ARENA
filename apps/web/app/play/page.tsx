  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] overflow-hidden bg-[#0a0f1e]">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(-45deg, transparent, transparent 3px, rgba(0, 229, 255, 0.012) 3px, rgba(0, 229, 255, 0.012) 4px)'
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="text-center mb-16 relative w-fit mx-auto px-8 py-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-4 relative z-10" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
            Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-cyan to-accent-purple" style={{ filter: 'drop-shadow(0 0 15px rgba(0,229,255,0.4))' }}>Battle Mode</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto relative z-10 opacity-[0.65]">
            Whether you want to climb the ranks, practice against AI, or challenge a friend,
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          ...
          {/* Ranked 1v1 */}
          <Link href="/battle" className="group flex flex-col h-full relative hover:-translate-y-[3px] transition-transform duration-200" style={{
            ...
            <div className="p-8 flex flex-col h-full z-10">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold text-gray-300" style={{
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-3 group-hover:text-[#00e5ff] transition-colors" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
                Ranked 1v1
              </h2>
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-sm font-bold text-[#080c18] py-3 rounded-lg overflow-hidden relative group/btn" style={{
          ...
          {/* vs AI Bot */}
          <Link href="/play/bot" className="group flex flex-col h-full relative overflow-hidden hover:-translate-y-[3px] hover:border-[#a855f7]/30 transition-all duration-200" style={{
            background: 'rgba(255, 255, 255, 0.025)',
            borderRadius: '12px',
            border: '1px solid transparent',
          }}>
            <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none group-hover:rotate-1 transition-transform duration-1000 ease-in-out">
              <svg width="100%" height="100%">
                <defs>
                  <pattern id="hexagons-sm" width="20" height="17.3" patternUnits="userSpaceOnUse" patternTransform="scale(2)">
                    <path d="M10 0L20 5.7V17.3L10 23L0 17.3V5.7L10 0Z" fill="none" stroke="#ffffff" strokeWidth="1" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#hexagons-sm)" />
              </svg>
            </div>
            ...
            <div className="p-8 flex flex-col h-full relative z-10">
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-3 group-hover:text-[#a855f7] transition-colors" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
                vs AI Bot
              </h2>
              <p className="text-gray-400 leading-relaxed flex-1">
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-sm font-bold py-3 rounded-lg transition-colors group/btn hover:bg-[#a855f7]/15" style={{
          ...
          {/* Private Room */}
          <div className="group flex flex-col h-full relative hover:-translate-y-[3px] transition-transform duration-200" style={{
            background: 'rgba(255, 255, 255, 0.025)',
            borderRadius: '12px',
            ...
            <div className="p-8 flex flex-col h-full z-10">
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-3 group-hover:text-[#10b981] transition-colors" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
                Private Room
              </h2>
              ...
              <div className="flex flex-col gap-3">
                <Link href="/play/private" className="flex items-center justify-center gap-2 text-sm font-bold py-3 rounded-lg transition-all hover:bg-[#10b981]/15 hover:shadow-[0_0_15px_rgba(16,185,129,0.2)]" style={{
