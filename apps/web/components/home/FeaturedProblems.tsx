        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {PROBLEMS.map((prob, i) => (
            <ScrollReveal key={prob.num} delay={i * 0.1} yOffset={20}>
              <Link href={`/problems`} className="glass-card p-6 flex flex-col h-full group hover:-translate-y-1 transition-transform border border-border hover:border-gray-500 bg-bg-card relative overflow-hidden">
