      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <ScrollReveal delay={0.1} yOffset={30} className="h-full">
            <Link href="/battle" className="glass-card p-8 rounded-2xl neon-border hover:border-accent-cyan/40 transition-all duration-300 group relative overflow-hidden flex flex-col h-full bg-bg-card">
          ...
          <ScrollReveal delay={0.2} yOffset={30} className="h-full">
            <Link href="/play/bot" className="glass-card p-8 rounded-2xl border border-border hover:border-accent-purple/40 shadow-[0_0_15px_rgba(168,85,247,0.05)] hover:shadow-[0_0_25px_rgba(168,85,247,0.15)] transition-all duration-300 group relative overflow-hidden flex flex-col h-full bg-bg-card">
          ...
          <ScrollReveal delay={0.3} yOffset={30} className="h-full">
            <Link href="/play/private" className="glass-card p-8 rounded-2xl border border-border hover:border-accent-green/40 shadow-[0_0_15px_rgba(16,185,129,0.05)] hover:shadow-[0_0_25px_rgba(16,185,129,0.15)] transition-all duration-300 group relative overflow-hidden flex flex-col h-full bg-bg-card">
